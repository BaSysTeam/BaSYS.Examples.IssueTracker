...
5. Replace `$schema` with `"../../system/schemas/metaObjectStorableSettings.schema.json"` (the example files use a deeper relative path because they live under `.agents/skills/create-enum/examples/`).
